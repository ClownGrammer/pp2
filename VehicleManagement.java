      ...
      do {
         ...
         switch (choice) {
            case 1:
               ...
               int year;
               double val;
               System.out.print("Enter registration number: "); reg = key.nextLine();
               System.out.print("Enter make: "); make = key.nextLine();
               System.out.print("Enter year of manufacture: "); year = key.nextInt();
               System.out.print("Enter value: "); val = key.nextDouble();
            ...
            case 3:
               // delete vehicle
               int index;
               System.out.print("Enter the index of the vehicle to delete: "); index = key.nextInt();
            ...
            case 4:
               ...
               "3. Back to main menu\n" + 
               "Enter your choice: "); sort = key.nextInt();
               if (sort == 1){
